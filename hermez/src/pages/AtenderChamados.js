                        ...
                        <div>{Array.isArray(listaChamado) && listaChamado.map(chamado =>
                            <details key={chamado.cha_cod}>
                                <summary  className="listaTabelaChamados">
                                    ...
                                    <p className="data">{ new Date(chamado.cha_dataInicio).toLocaleDateString() }</p>
                                    <p className="cliente">{ chamado.fun_nome }</p>
                                    <p className="titulo">{ chamado.cha_titulo }</p>
                                    <p className="status">{ chamado.sta_nome.toUpperCase() }</p>
                                    <p className="tipo">{ chamado.ser_nome.toUpperCase() }</p>
                                </summary>
                                <div className="divDescricaoChamado">
                                    <p>{ chamado.cha_desc }</p>
                                    <div className="botoes">
                                        <Link to='/funcionario/chats'>
                                            <button className="iniciar" onClick={() => localStorage.setItem('cha_cod', chamado.cha_cod)}>Iniciar</button>
                                        </Link>
